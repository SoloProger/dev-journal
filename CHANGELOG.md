...
## [0.0.0] *2023-07-24* Клиент

### Добавлено

* Вывод постов
* Отдельная страница поста
* Форма добавления поста (только верстка)
* Модальное окно
* Пагинация
* `Footer`
...
## [0.0.0] *2023-07-24* Сервер: Сущность "Category"
...
## [0.0.0] *2023-06-24* Сервер: сущность "Post"
